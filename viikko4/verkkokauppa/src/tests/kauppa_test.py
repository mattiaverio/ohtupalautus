...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            if tuote_id == 1:
                ...
                return Tuote(2, "kissa", 15)
            elif tuote_id == 3:
                return Tuote(3, "koira", 30)
    ...
    def test_ostoksen_paatyttya_metodi_tilisiirto_kutsutaan_oikein(self):
    ...
    def test_ostetaan_tuote_varastossa_ja_tuote_joka_loppu(self):
    ...
    def test_kauppa_pyytaa_uuden_viitenumeron_uudelle_ostokselle(self):
        ...
        self.pankki_mock.tilisiirto.assert_called_with("liisa", 43, "54321", ANY, 5)
